...
insert into Products values('Hamburger',20.50,'200g 100% wołwiny, pomodor, sałta, pikle, czerwona cebula oraz włsnoręznie robony sos')
insert into Products values('Cheeseburger',22.00,'200g 100% wołwiny, ser cheedar, ser mimolette, pikle, czerwona cebula oraz włsnoręcznie robiony sos')
insert into Products values('Chili Burger',22.00,'200g 100% wolwiny, pomodor, sałta, pikle, czerwona cebula, papryka jalapeno, tabasco oraz włsnoręcznie robony ostry sos')
insert into Products values('Mexican Burger',23.00,'200g 100% wołwiny, pomodor, sałta, pikle, czerwona cebula, papryka jalapeno, nachosy, salsa, sos serowy')
insert into Products values('Double Burger',27.50,'400g 100% wołwiny, pomodor, sałta, pikle, czerwona cebula oraz włsnoręcznie robony sos')
insert into Products values('DIY Burger',25.50,'200g wołwiny oraz wolna amerykanka, ze swojego burgera!')
insert into Products values('Frytki',7.50,'Duża porcja ciełich frytek z 1 sosem do wybory(ketchup, majonez, serowy)')
...
insert into Addresses values('Krakow','30-999','Warszawska','25b',null)
insert into Addresses values('Kraków','30-696','Filipa','10',null)
insert into Addresses values('Kraków','30-696','Filipa','10',null)
insert into Restaurants values(1)
insert into Staff values('GigaSzef','123','Manager','Adam','Nowak','01347412352','lubiekoty@wsei.com',default,null,2,1)
insert into Staff values('owner','asd','Owner','Kuba','Pawlikowski','92318413451','nielubiekoty@wsei.com',default,null,3,1)
